...
<img src="assets/logo.png" width="520px" height="110px" alt="logo.png">
...
|-----	|--------------------------------------	|-----------------	|---------------------------------------------------------------------------------------	|---------------------	|------------	|----------------	|----------------------------------------------------------------------------------------------------------------------	|-----------------	|-----------	|
| 001 	| test_if_form_is_valid                	| Prueba unitaria 	| Comprobar que todos los campos del formulario de registro son validos.                	| Prueba automatizada 	| 15/03/2024 	| Andres Silvera 	| {"username": "andressilvera12", "email": "andres12@gmail.com", "password1": "3144300Ua", "password2": "3144300Ua"}   	| True            	| Aprobado  	|
| 002 	| test_if_form_is_not_valid            	| Prueba unitaria 	| Comprobar que los datos ingresados en el formulario de registro son invalidos.        	| Prueba automatizada 	| 15/03/2024 	| Andres Silvera 	| {"username": "andressilvera12", "email": "andres12@gmail.com", "password1": "3144300UUUa", "password2": "3144300Ua"} 	| False           	| Aprobado  	|
| 003 	| test_send_data_form                  	| Prueba unitaria 	| Comprobar que el codigo de estado recibido desde el servidor es 200.                  	| Prueba automatizada 	| 15/03/2024 	| Andres Silvera 	| {"username": "andressilvera12", "email": "andres12@gmail.com", "password1": "3144300UA", "password2": "3144300UA"}   	| 200             	| Aprobado  	|
| 004 	| test_send_data_form_error_404        	| Prueba unitaria 	| Comprobar que los datos enviados son incorrectos y el servidor devuelve un error 404. 	| Prueba automatizada 	| 15/03/2024 	| Andres Silvera 	| {"username": "andressilver", "email": "andregmail.com", "password1": "3144300", "password2": "3144a"}                	| 404             	| Aprobado  	|
| 005 	| test_home_view_returns_200_ok        	| Prueba unitaria 	| La vista "home" debe retornar un codigo de estado 200.                                	| Prueba automatizada 	| 15/03/2024 	| Andres Silvera 	| "Home"                                                                                                               	| 200             	| Aprobado  	|
| 006 	| test_home_view_fail                  	| Prueba unitaria 	| La vista "home" debe retornar un codigo de estado 404.                                	| Prueba automatizada 	| 15/03/2024 	| Andres Silvera 	| "Home"                                                                                                               	| 404             	| Aprobado  	|
| 007 	| test_template_associated_to_url_pass 	| Prueba unitaria 	| Comprobar el template y la url asociada a la vista                                    	| Prueba automatizada 	| 15/03/2024 	| Andres Silvera 	| "base.html"                                                                                                          	| OK              	| Aprobado  	|
...
<img src="assets/contacts.gif" alt="contacts.gif">

### Control de inventario
<img src="assets/inventory.gif" alt="inventory.gif">

### Sistema de tickets (customer service)
<img src="assets/tickets.gif" alt="tickets.gif">