...
class CustomersManagement(models.Model):
    ...
    address = models.CharField("Adress", max_length=17, null=True)
    ...
    preference = models.CharField("Interaction", max_length=17, null=True)
    notes = models.TextField("Notes", max_length=100, null=True)
    campaing = models.CharField("Campaing", max_length=20, null=False, default="Null")
    email = models.EmailField("Email customer", null=False)
    phone_number = models.CharField("Customers number", max_length=20, null=False)
